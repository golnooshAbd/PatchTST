...
for target_node in Tpot VPdef rho SWDR OT
# OT p T Tpot Tdew rh VPmax VPact VPdef sh H2OC rho wv max_wv wd rain raining SWDR PAR max_PAR Tlog
...
do
    ...
    data_path_name=weather_noOutlier_limited5.csv
    model_id_name=weather_noOutlier_limited5
    data_name=custom
