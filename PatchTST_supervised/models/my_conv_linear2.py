...
class Model(nn.Module):
    def __init__(self, configs):
        ...
        self.embedding2 = nn.Conv1d(in_channels=d_model//4, out_channels=d_model//2, kernel_size=kernel_size, bias=True, stride=stride)
        self.embedding3 = nn.Conv1d(in_channels=d_model//2, out_channels=d_model, kernel_size=kernel_size, bias=True, stride=stride)
    ...
    def forward(self, x):           # x: [Batch, Input length, Channel]
        ...
        x = self.embedding3(x)  # -> [Batch, Channels2, Input Length''']
